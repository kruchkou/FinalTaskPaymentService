...
public class BlockAccountCommand extends AuthCommand {

    private static final Logger logger = Logger.getLogger(BlockAccountCommand.class);

    private static final String ERROR_MESSAGE = "Error at BlockAccountCommand";
    ...
    protected void process(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            accountService.setStatus(accountID, STATUS_BLOCKED);
