...
public class GoToEditOrgConfirmCommand extends AuthCommand {
    ...
    private static final String FRAGMENT_EDIT_ORG_CONFIRM_URL = "payments_content/admin/admin_edit_org_confirm.jsp";
    ...
    protected void process(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (accountInfo == null || accountInfo.getStatus().getId() != STATUS_OPEN) {
            ...
            req.setAttribute(ATTRIBUTE_ADMIN_FRAGMENT, FRAGMENT_EDIT_ORG_CONFIRM_URL);
