...
<fmt:message key="pay.submit_payment" var="locale_submit_payment"/>
<fmt:message key="pay.org_to" var="locale_pay_org_to"/>
...
<div class="container mt-3">
    <h1>${locale_submit_payment.toUpperCase()}</h1>
    <div class="progress">
    ...
    <div class="card">
        ...
        <div class="card-body center_box">
            <div class="d-flex">
                ...
                <p class="mb-0 mr-3">
                    ${locale_balance}: ${account.balance} BYN</p>
            </div>
        </div>
    </div>
    <div class="card mt-2">
    ...
    <div class="card mt-2">
        <div class="card-body d-flex">
            ...
            <input form="payForm" style="width: 30%" type="number" class="mx-3 form-control" name="amount"
                   id="amountInput" required min="0.01" max="${account.balance}" step="0.01"
                   placeholder="${locale_pay_up_to} ${account.balance} BYN">
        </div>
    </div>
    ...
    <div class="card mt-2">
        <div class="card-body d-flex">
            ...
            <input form="payForm" style="width: 90%" type="text" class="mx-3 form-control" id="commentInput"
                   name="comment" placeholder="${locale_pay_optional}">
        </div>
    </div>
    ...
    <div class="card mt-2">
        <div class="card-body d-flex">
            ...
            <input form="payForm" style="width: 50%" type="password" class="mx-3 form-control" name="password"
                   id="passwordInput" required>
            <input form="payForm" style="width: 30%" type="submit" class="btn ml-auto btn-success"
                   value="${locale_payment_pay.toUpperCase()}">
        </div>
    </div>
